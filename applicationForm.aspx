<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="applicationForm.aspx.cs" Inherits="user2_applicationForm" %>
...
&nbsp;<asp:TextBox ID="txtroll" runat="server" class="form-control"></asp:TextBox>
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label18" AssociatedControlID="txtpassword" runat="server" Text="Password :"></asp:Label>
