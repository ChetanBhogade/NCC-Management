...
public partial class user2_applicationForm : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       //      {
                ...
                string query = "insert into tbl_application_form(FormNumber,rollno,full_name,father_name,mother_name,address,near_railway_stn,near_police_stn,phone_no,blood_group,sex,qualification,college_stream,dob,email,adhar_no,ifsc_code,bank_acc_no) values('" + formnumber + "','" + txtroll.Text + "','" + txtname.Text + "','" + txtfname.Text + "','" + txtmname.Text + "','" + txtaddress.Text + "','" + txtnrs.Text + "','" + txtnps.Text + "','" + txtphone.Text + "','" + txtblood.Text + "','" + DropDownList1.Text + "','" + txtqualification.Text + "','" + txtcollege.Text + "','" + txtdob.Text + "','" + txtemail.Text + "','" + txtadhar.Text + "','" + txtifsc.Text + "','" + txtbankacc.Text + "')";
                ...
                if (result > 0)
                {
                    ...
                    Response.Write("<script>Form Inserted Successfully.</script>");
